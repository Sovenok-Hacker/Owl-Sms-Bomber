...
message8 = """    \n         Разработчики:  
                  ...
                  \n \033[94mАртём Хвостов\033[0m - email: artemka.hvostov@yandex.ru VK: https://vk.com/duolomyowls
                  \n                                      
                  \n                                      
                                                                      """
...
message4 =  "Атака началась на ||" + str(_phone)+ "||\033[94mSmsFlood\033[0m"
...
if call == str(2):
    ...
    while True:
        ...
        try:
            ...
            R = R + 1
            print('[+] Delivery отправлено! || Кол-во - ' + str(R))
            print('Возникли вопросы ? Пишите разработчику на email [ --> artemka.hvostov@yandex.ru <-- ]')
            time.sleep(0.1)
        except:
            print('[-] Ошибка отправки!')
