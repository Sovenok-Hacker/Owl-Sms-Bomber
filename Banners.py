...
def banner3():
  ...
  banner2 = """
               OWL SMS BOMBER
                ...
                \033[32mv.10.1\033[33m (Разработчик: \033[31mАртём Хвостов\033[33m)
...
def banner1an():
    ...
    banner1 = """
                 OWL SMS BOMBER
                  ...
                  v.10.1 (Разработчик: Артём Хвостов)
                       Ваша система - Linux/Android
                              Сервисы - 320
"""
    r=0
...
def banner_atack():
  ...
  time.sleep(2)
  print(Fore.RED)
  print("Атака началась на ||" + str(_phone)+ "||\033[94mSmsFlood\033[0m")
...
def start(): 
  os.system("title Owl-SMS-Bomber")
  print(Fore.YELLOW)
  os.system("clear")
  os.system("CLS")
  for char in message:
